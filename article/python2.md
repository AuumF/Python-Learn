...
创建字典的实列:   
```python
dict1 = {"a" : 123 , "b" : 234 , "c" : 345}
dict2 = {"abc" : 123 , 123 : "abc"}
```
注意字典创建时，值(value)可以为任意值且可以重复，但是键(key)具有唯一性，不能重复出现   
#### 3.字典的访问
字典的访问只用访问字典的键(key),就可以访问到字典每个元素的值(value),实例如下:   
```python
dict2 = {"abc" : 123 , 123 : "abc"}
print(dict2["abc"])
print(dict2[123])
```
输出结果如下:   
![输出](/picture/屏幕截图%202024-05-04%20223523.png)   
#### 4.字典的修改
字典的修改可以在最后新加键值对，同时也可以对已有的键值对进行更新和修改，示例如下:   
```python
dict1 = {"a" : 123 , "b" : 234 , "c" : 345}
print(dict1)
dict1["d"] = 456
...
```
输出结果如下:
![图片](/picture/屏幕截图%202024-05-04%20224234.png)   
#### 5.字典的删除
字典的删除可以删除字典中的键值对，也可以删除整个字典，示例如下:   
```python
dict1 = {"a" : 123 , "b" : 234 , "c" : 345}
print(dict1)
del dict1["b"]
...
```
输出如下:   
![图片](/picture/屏幕截图%202024-05-04%20224618.png)   

#### 6.字典使用时的注意事项
(1) dict （字典）是不允许一个键创建两次的，但是在创建 dict （字典）的时候如果出现了一个键值赋予了两次，会以最后一次赋予的值为准   
例如:   
```python
dict1 = {"a" : 123 , "b" : 234 , "c" : 345 , "b" : 555}
print(dict1)
print("b")
```
输出如下:   
![](/picture/屏幕截图%202024-05-04%20230234.png)   

(2) dict （字典）键必须不可变，可是键可以用数字，字符串或元组充当，但是就是不能使用列表
```python
dict1 = {"a" : 123 , "b" : 234 , 1 : 345 , ("abc" , 444) : 456}
print(dict1)
print(dict1[("abc" , 444)])
```
输出如下:   
![](/picture/屏幕截图%202024-05-04%20230616.png)   
